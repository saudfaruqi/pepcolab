...
const LINK_CHARGED_TOTAL_AED: Record<string, number> = {
  'PL-YL6IET': 900,  // 10mg Pen × 1 
  'PL-BVQC55': 1000,  // 20mg Pen × 1
  'PL-HN08LB': 1100,  // 30mg Pen × 1
  'PL-0QQSVU': 1200,  // 40mg Pen × 1
  'PL-BTMFTN': 1300,  // 50mg Pen × 1
  'PL-ZOWHNN': 1400,  // 60mg Pen × 1
  'PL-RGKVJV': 2800, // 60mg Pen × 2 
  'PL-E1E84I': 4200, // 60mg Pen × 3 
  'PL-RETZGA': 1460,  // 60mg Vial × 1
}
