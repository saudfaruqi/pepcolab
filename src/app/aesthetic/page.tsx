...
export const metadata: Metadata = {
  title: 'Aesthetic Peptides: Research Overview & Compound Guide',
  description:
    'Which peptides appear most in skin, dermal and cosmetic research literature, how the copper peptides differ, and how to check batch documentation before you order.',
  alternates: {
    canonical: '/aesthetic',
