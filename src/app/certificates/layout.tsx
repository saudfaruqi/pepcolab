...
export const metadata: Metadata = {
  ...
  description:
    'Look up the published Certificate of Analysis for any PepcoLab peptide batch by product and lot number. Independent COA verification for every research compound shipped to the UK and UAE.',
